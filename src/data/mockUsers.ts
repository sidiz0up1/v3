...
export const mockUsers: UserData[] = [
  {
    ...
    data: {
      userInfo: { 
        name: '건강형', gender: '남성', age: '20~34', height: '175', weight: '70',
        shoulderWidth: '400', sittingHeight: '920', poplitealHeight: '430'
      },
      front: {
  ...
  },
  {
    ...
    data: {
      userInfo: { 
        name: '상체말림', gender: '여성', age: '20~34', height: '160', weight: '50',
        shoulderWidth: '350', sittingHeight: '850', poplitealHeight: '380'
      },
      front: {
  ...
  },
  {
    ...
    data: {
      userInfo: { 
        name: '좌우비대칭', gender: '남성', age: '35~49', height: '180', weight: '85',
        shoulderWidth: '420', sittingHeight: '940', poplitealHeight: '440'
      },
      front: {
  ...
  },
  {
    ...
    data: {
      userInfo: { 
        name: 'O다리형', gender: '여성', age: '20~34', height: '165', weight: '55',
        shoulderWidth: '370', sittingHeight: '880', poplitealHeight: '400'
      },
      front: {
        rightShoulderSlope: 20,
        leftShoulderSlope: 20,
  ...
  },
  {
    ...
    data: {
      userInfo: { 
        name: '골반요추', gender: '남성', age: '50+', height: '170', weight: '75',
        shoulderWidth: '390', sittingHeight: '900', poplitealHeight: '410'
      },
      front: {
        rightShoulderSlope: 20,
        leftShoulderSlope: 20,
  ...
  },
  {
    ...
    data: {
      userInfo: { 
        name: '복합불균형', gender: '여성', age: '35~49', height: '158', weight: '62',
        shoulderWidth: '360', sittingHeight: '840', poplitealHeight: '370'
      },
      front: {
